...
from .v8_schema10_simulation import run_v8_schema10_local_simulation
...
def _simulate(config_path: str, output_override: str = None) -> int:
    ...
    if config.protocol_version == 8:
        if config.v8_schema_version == 10:
            result = run_v8_schema10_local_simulation(config)
        elif config.v8_schema_version == 9:
