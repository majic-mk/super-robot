    ...
    def __init__(
        ...
        *,
        ...
        expected_v8_engine = {
            ...
            9: CacheBlendV8Schema8OnlineEngine,
            10: CacheBlendV8Schema8OnlineEngine,
        ...
        if protocol_version == 8 and runtime_schema_version not in {5, 6, 7, 8, 9, 10}:
        ...
        def operation() -> GenerationTrace:
            return self._reuse_generate(
                ...
                force_nonpaper_measurement_admission=(
                    self.runtime_schema_version in {8, 9, 10} and repair_ratio < 1.0
                ),
            )
    ...
    def execute_with_samples(
        ...
        if job.kind in (V6A800JobKind.CORRECTNESS, V6A800JobKind.UNION_REPAIR):
            ...
            integrity = self._reuse_generate(
                ...
                force_nonpaper_measurement_admission=(
                    self.runtime_schema_version in {8, 9, 10} and job.repair_ratio < 1.0
                ),
            )
